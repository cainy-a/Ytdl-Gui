namespace Ytdl_Gui
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.checkBoxExtract      = new System.Windows.Forms.CheckBox();
			this.checkBoxRedownload   = new System.Windows.Forms.CheckBox();
			this.SuspendLayout();
			// 
			// label1
			// 
			...
			// checkBoxExtract
			// 
			this.checkBoxExtract.Location                = new System.Drawing.Point(136, 295);
			this.checkBoxExtract.Name                    = "checkBoxExtract";
			this.checkBoxExtract.Size                    = new System.Drawing.Size(104, 19);
			this.checkBoxExtract.TabIndex                = 14;
			this.checkBoxExtract.Text                    = "Download Audio ";
			this.checkBoxExtract.UseVisualStyleBackColor = true;
			// 
			// checkBoxRedownload
			// 
			this.checkBoxRedownload.Location                = new System.Drawing.Point(246, 295);
			this.checkBoxRedownload.Name                    = "checkBoxRedownload";
			this.checkBoxRedownload.Size                    = new System.Drawing.Size(130, 19);
			this.checkBoxRedownload.TabIndex                = 14;
			this.checkBoxRedownload.Text                    = "Force update YTDL";
			this.checkBoxRedownload.UseVisualStyleBackColor = true;
			// 
			// Form1
			// 
			...
			this.Controls.Add(this.checkBoxRedownload);
			this.Controls.Add(this.checkBoxExtract);
		...
		private System.Windows.Forms.CheckBox checkBoxExtract;
		private System.Windows.Forms.CheckBox checkBoxRedownload;
